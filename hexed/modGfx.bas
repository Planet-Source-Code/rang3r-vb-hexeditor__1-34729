...
Public Sub PaintEdge(ByVal hdc As Long, ByVal LeftX As Long, ByVal TopY As Long, ByVal rightX As Long, ByVal bottomY As Long)
    Dim tRect As RECT
    With tRect
        .Left = LeftX
        .Top = TopY
        ...
        .Bottom = bottomY
    End With
    Call DrawEdge(hdc, tRect, EDGE_RAISED, BF_RECT)
End Sub
